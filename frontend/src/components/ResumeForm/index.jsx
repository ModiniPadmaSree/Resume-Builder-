...
const ResumeForm = ({ formData, setFormData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://resume-builder-api-r6ts.onrender.com/api/resumes', {
        method: 'POST',
        headers: {
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      <section className={styles.section}>
        ...
        {/* You could add a 'certificates' field to Suggestions.jsx if you want tips here */}
        {/* {currentField === 'certificates' && <Suggestions field="certificates" />} */}
      </section>
